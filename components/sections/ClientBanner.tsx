  ...
  return (
    <section className="bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 py-12 px-5">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <p data-ngf-field="clientbanner.headline" data-ngf-label="Headline" data-ngf-type="text" data-ngf-section="Client Banner" className="font-sora font-semibold text-lg text-slate-900 dark:text-white mb-1">
            {bannerHeadline}
          </p>
          <p data-ngf-field="clientbanner.subheadline" data-ngf-label="Subheadline" data-ngf-type="textarea" data-ngf-section="Client Banner" className="text-sm text-slate-500 dark:text-slate-400 font-inter">
            {bannerSubheadline}
          </p>
        </div>
        <Link

    ...
    <section id="features" className="py-24 bg-white dark:bg-slate-950">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 data-ngf-field="features.title" data-ngf-label="Title" data-ngf-type="text" data-ngf-section="Features" className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl mb-4">
            {featuresTitle}
          </h2>
          <p data-ngf-field="features.subtitle" data-ngf-label="Subtitle" data-ngf-type="textarea" data-ngf-section="Features" className="text-lg text-slate-600 dark:text-slate-400">
            {featuresSubtitle}
          </p>
        </div>
          ...
          {features.map((feature) => (
            <div key={feature.title} className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h3 data-ngf-field={`feature${features.indexOf(feature)}.title`} data-ngf-label="Title" data-ngf-type="text" data-ngf-section="Features" className="font-sora font-semibold text-base text-slate-900 dark:text-white mb-2">
                  {feature.title}
                </h3>
                <p data-ngf-field={`feature${features.indexOf(feature)}.description`} data-ngf-label="Description" data-ngf-type="textarea" data-ngf-section="Features" className="text-sm text-slate-500 dark:text-slate-400 font-inter leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </div>
